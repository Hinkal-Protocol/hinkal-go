...
var (
	...
	ErrTransactionCanceled      = errors.New("transaction was cancelled. Please try again")
	...
	ErrLowOutputAmount          = errors.New("gas fees exceed received amount. Please try adjusting amount or lowering slippage.")
